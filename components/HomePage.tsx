   ...
   return (
      <div className="w-full h-screen session-home">
         ...
         >
            ...
            <div className="flex flex-col flex-grow items-center space-y-7 mt-5 lg:pr-20 lg:justify-start lg:items-start">
               <h1 className="text-white text-2xl font-bold sm:text-3xl lg:text-5xl">
                  Hi! I&apos;m Le Quoc Huy <br />
                  <span className=" font-bold text-xl sm:text-2xl lg:text-4xl">Web Developer !</span>
               </h1>
               <p className="text-white bg-zinc-900 text-sm sm:text-lg max-w-2xl lg:text-xl 2xl:max-w-3xl">
                  Hi guys! My name is Huy, currently a student at Mindx School
                  of Technology. Previously, I studied at Nam Can Tho University and
                  prepare graduate with a major in automotive engineering
